...
import cc.fstu.pinestyle.VisualizationUtils
import cc.fstu.pinestyle.YuvToRgbConverter
import cc.fstu.pinestyle.data.Camera
import cc.fstu.pinestyle.data.Person
import cc.fstu.pinestyle.ml.PoseClassifier
import cc.fstu.pinestyle.ml.PoseDetector
        ...
        imageReader?.setOnImageAvailableListener({ reader ->
            ...
            if (image != null) {
                if (! ::imageBitmap.isInitialized) {
                    imageBitmap =
                        createBitmap(PREVIEW_WIDTH, PREVIEW_HEIGHT)
                }
